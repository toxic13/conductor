...
public class ActionProcessor {
    ...
    public Map<String, Object> execute(Action action, String payload, String event, String messageId) {
        ...
        switch (action.getAction()) {
            case start_workflow:
                return startWorkflow(action, payload, event, messageId);
            case complete_task:
                return completeTask(action, payload, action.getComplete_task(), Status.COMPLETED, event, messageId);
            case fail_task:
                return completeTask(action, payload, action.getFail_task(), Status.FAILED, event, messageId);
            default:
                break;
        }
    ...
    private Map<String, Object> completeTask(Action action, String payload, TaskDetails taskDetails, Status status, String event, String messageId) {
    ...
    private Map<String, Object> startWorkflow(Action action, String payload, String event, String messageId) {
